...
namespace VLB
{
    public static class EditorStrings
    {
        ...
        public static class TriggerZone
        {
            ...
            public const string HelpDescription = "Generate a Collider with the same shape than the beam";
...
- GPU Instancing: Dynamically batch multiple beams to combine and reduce draw calls.");
            ...
            public const string SrpAndMultiPassNoCompatible = "Using a Scriptable Render Pipeline with Multi-Pass Rendering Mode is not supported:\nplease choose either the Single-Pass or GPU Instancing Rendering Mode";
            public const string GeometryGpuInstancingNotSupported = "GPU Instancing Rendering Mode is only supported on Unity 5.6 or above!\nSingle Pass will be used.";
            ...
            public static readonly GUIContent CreateOverrideAsset = new GUIContent("Create a 'Config Override' asset to edit these properties", "");
